...
@section('page-title', 'Riwayat Alat')
...
<form action="{{ route('peminjam.riwayat-alat') }}" method="GET"
    ...
    <div id="filterPanel"
        ...
        <div class="flex justify-between items-center mb-3">
            ...
            <a href="{{ route('peminjam.riwayat-alat') }}"
   ...
   <div class="text-sm text-gray-600">
            @if($tanggal)
                Menampilkan
                <span class="font-semibold">{{ $riwayatAlat->count() }}</span>
                aktivitas pada
        ...
        @else
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-1/6">Kontak Peminjam</th>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">
                                            @if($item->kontak_peminjam)
                                                <a href="https://wa.me/{{ $item->kontak_peminjam }}" 
                                                target="_blank"
                                                class="text-sm text-green-600 hover:underline">
                                                    {{ $item->kontak_peminjam }}
                                                </a>
                                            @else
                                                -
                                            @endif
                    ...
                    <div class="px-6 py-4">
                        {{ $riwayatAlat->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            </div>
        @endif
