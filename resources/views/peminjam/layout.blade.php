            ...
            <aside
                ...
                <nav class="mt-4">
                    ...
                    <a href="{{ route('peminjam.riwayat-alat') }}"
                        class="sidebar-link flex items-center px-6 py-3 text-gray-700 {{ request()->routeIs('peminjam.riwayat-alat') ? 'active' : '' }}">
                        <span class="sidebar-icon text-lg"><i class="fas fa-tools"></i></span>
                        <span class="sidebar-text">Riwayat Alat</span>
                    </a>
                    <a href="{{ route('peminjam.riwayat-material') }}"
                        class="sidebar-link flex items-center px-6 py-3 text-gray-700 {{ request()->routeIs('peminjam.riwayat-material') ? 'active' : '' }}">
                        <span class="sidebar-icon text-lg"><i class="fas fa-cube"></i></span>
                        <span class="sidebar-text">Riwayat Material</span>
                    </a>
                </nav>
