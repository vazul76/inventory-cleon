...
Route::get('/riwayat-alat', [PeminjamController::class, 'riwayatAlat'])->name('peminjam.riwayat-alat');
Route::get('/riwayat-material', [PeminjamController::class, 'riwayatMaterial'])->name('peminjam.riwayat-material');